...
def validate_plan(domain_path, problem_path) -> tuple[bool, str]:
    ...
    command = f"python3 fast-downward-24.06.1/fast-downward.py {domain_path} {problem_path} --search \"astar(blind())\""
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if valid:
            ...
            new_pddl = reflect_on_invalid_pddl(lore, DOMAIN_PATH.read_text(), PROBLEM_PATH.read_text(), validation_output, llm)
